...
type AdminFriendLinkController struct {
	AdminController
}

func (c *AdminFriendLinkController) Edit() {
...
func (c *AdminFriendLinkController) GetList() {
	mFriendLink := models.FriendLink{}
...
func (c *AdminFriendLinkController) Delete() {
